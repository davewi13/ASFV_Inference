...
enum PriorType { UNIFORM_PRIOR, GAMMA_PRIOR, TRUNC_GAMMA_PRIOR, EXP_PRIOR, BETA_PRIOR};// Defines different types of prior

enum EventType { EXPOSE, INFECT, RECOVERY, TERMINATE};  // Defines different types of event

enum PropType{ ADD_UNOBS, REM_UNOBS, RESAMPLE_OBS, RESAMPLE_UNOBS};
...
struct Individual{         // Information about an individuals
	...
	bool obs;                // Set to true if the individual is observed
